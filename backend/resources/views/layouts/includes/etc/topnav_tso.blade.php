...
@endif
      ...
      <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="{{ route('tso.dashboard') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('tso.tso') }}"><i class="fa fa-circle-o text-aqua"></i>Profile</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('tso.retailer') }}"><i class="fa fa-circle-o text-aqua"></i>Add Retailer</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <!-- <li><a href="{{ route('tso.dailySalesReport') }}"><i class="fa fa-circle-o text-aqua"></i>Daily Sales Report</a></li>
                    
            <li><a href="{{ route('tso.dailyCampaignReport') }}"><i class="fa fa-circle-o text-aqua"></i>Daily Campaign Report</a></li> -->


            <li><a href="{{ route('tso.dailyRetailerStockReportForUpazila') }}"><i class="fa fa-circle-o text-aqua"></i>Retailer Stock Report</a></li>
            <li><a href="{{ route('tso.dailySalesReportWithUpazila') }}"><i class="fa fa-circle-o text-aqua"></i>Sales Report Per Upazila</a></li>
            
            <li><a href="{{ route('tso.dailyCampaignReportWithUpazila') }}"><i class="fa fa-circle-o text-aqua"></i>Campaign Report Per Upazila</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('tso.wcheckProduct') }}"><i class="fa fa-circle-o text-aqua"></i>Warranty Check</a></li>
          </ul>
        </li>
