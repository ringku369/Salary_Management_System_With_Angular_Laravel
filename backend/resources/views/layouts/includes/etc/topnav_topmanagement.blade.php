...
@endif
      ...
      <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="{{ route('topmanagement.dashboard') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('topmanagement.topmanagement') }}"><i class="fa fa-circle-o text-aqua"></i>Profile</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('topmanagement.dailySalesReport') }}"><i class="fa fa-circle-o text-aqua"></i>Daily Sales Report</a></li>

            <li><a href="{{ route('topmanagement.dailyCampaignReport') }}"><i class="fa fa-circle-o text-aqua"></i>Daily Campaign Report</a></li>

            <li><a href="{{ route('topmanagement.dailyReplaceReport') }}"><i class="fa fa-circle-o text-aqua"></i>Daily Replace Report</a></li>

            <li><a href="{{ route('topmanagement.dailyRetailerStockReport') }}"><i class="fa fa-circle-o text-aqua"></i>Daily Retailer Stock Report</a></li>

            <li><a href="{{ route('topmanagement.dailyStockReport') }}"><i class="fa fa-circle-o text-aqua"></i>Daily Stock Report</a></li>

            <li><a href="{{ route('topmanagement.dailyPurchaseSaleReport') }}"><i class="fa fa-circle-o text-aqua"></i>Daily Purchase Or Sales Report</a></li>

            <li><a href="{{ route('topmanagement.dailyDistributorSalesReport') }}"><i class="fa fa-circle-o text-aqua"></i>Distributor Daily Sales Report</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('topmanagement.wcheckProduct') }}"><i class="fa fa-circle-o text-aqua"></i>Warranty Check</a></li>
          </ul>
        </li>
