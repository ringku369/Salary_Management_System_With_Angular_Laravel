                    ...
                    <main class="col-12 p-0">
                        <div class="row">
                            <div class="col-12 align-self-center">
                                ...
                                <!-- Image -->
                                <div class="gallery">
                                    <a href="{{ asset('resources/lib/frontend/assets/images/bg_1.jpg') }}">
                                        <img src="{{ asset('resources/lib/frontend/assets/images/bg_1.jpg') }}" class="w-100">
                                    </a>
                                </div>
