                        ...
                        <div class="slide-content row">
                            <div class="col-12 d-flex inner">
                                <div class="center align-self-center text-center">
                                    <h1 data-aos="zoom-out-up" data-aos-delay="400" class="title effect-static-text">Structural Rehab</h1>
                    ...
                    <main class="col-12 p-0">
                        <div class="row">
                            <div class="col-12 align-self-center">
                                ...
                                <!-- Image -->
                                <div class="gallery">
                                    <a href="{{ asset('resources/lib/frontend/assets/images/s_r.png') }}">
                                        <img src="{{ asset('resources/lib/frontend/assets/images/s_r.png') }}" class="w-100">
                                    </a>
                                </div>
