...
{{-- for for displaying success and errror message --}}
  <form class="form-horizontal" method="POST" action="{{ route('admin.cat.store') }}" autocomplete="on" enctype="multipart/form-data">
<div class="box-body">
    @if(count($errors))
...
<!-- body part -->
  ...
  <form action="{{route('admin.cat.delete',$element['id'])}}" method="post">
